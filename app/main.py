...
def build_feature_frame(df: pd.DataFrame, ticker: str = "") -> pd.DataFrame:
    ...
    # Default all sentiment columns to 0.0
    ...
    # Merge historical sentiment from cache when ticker is known
    if ticker:
        try:
            ...
            pass  # Never let sentiment errors crash the prediction
...
def forecast_next_days(
    ...
    # Inject live sentiment into the inference feature vector
...
def predict(payload: PredictionRequest) -> PredictionResponse:
    try:
        ...
        # Fetch live headlines and score with Gemini
